...
<html lang="en">
    <head>
        ...
        <link href="../../datatables/plugins/bootstrap/datatables.bootstrap.css" rel="stylesheet" type="text/css" />
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="../../layout2/img/logo-default.png" alt="logo" class="logo-default" /> </a>
                ...
                <a href="javascript:;" class="menu-togg ler responsive-toggler" data-toggle="collapse" data-target=".navbar-collapse"> </a>
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    ...
                                    @if(Sentinel::check())
                                    <span class="username username-hide-on-mobile"> {{ Sentinel::getUser()->name }} </span>
                                    @else
...
<![endif]-->
            ...
            <script src="../../layout2/scripts/layout.min.js" type="text/javascript"></script>
            <script src="../../layout2/scripts/demo.min.js" type="text/javascript"></script>
            ...
            <script src="../../datatables/plugins/bootstrap/datatables.bootstrap.js" type="text/javascript"></script>
