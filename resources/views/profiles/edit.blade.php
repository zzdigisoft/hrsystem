                            ...
                            <div class="profile-sidebar">
                                ...
                                <div class="portlet light profile-sidebar-portlet ">
                                    ...
                                    <div class="profile-usertitle">
                                        ...
                                        <div class="profile-usertitle-job"> {{ $profile->position }} </div>
                                    </div>
                                    <!-- END SIDEBAR USER TITLE -->
                                    <div class="margin-top-20 profile-desc-link" style="margin-left: 20px">
                                        <i class="fa fa-phone"></i>
                                        <a href="http://www.keenthemes.com">{{ $profile->phone }}</a>
                                    </div>
                                    <div class="margin-top-20 profile-desc-link" style="margin-left: 20px">
                                    <i class="fa fa-home"></i>
                                    <a href="http://www.twitter.com/keenthemes/">{{ $profile->current_address }}</a>
                                    </div>
                                    <div class="margin-top-20 profile-desc-link" style="margin-left: 20px">
                                    <i class="fa fa-envelope-o"></i>
                                    <a href="http://www.facebook.com/keenthemes/"> {{ $profile->email }} </a>
                                    </div>
                                    <!-- SIDEBAR MENU -->
                                                    ...
                                                    <div class="tab-pane active" id="tab_1_1">
                                                        <form role="form" action="/profiles" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" placeholder="John Smith" class="form-control" name="name" value="{{ $profile->name }}" />  </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Tempat Lahir</label>
                                                                <input type="text" placeholder="Jakarta" class="form-control" name="place_birth" value="{{ $profile->place_birth }}" />  </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Tanggal Lahir</label>
                                                                <input type="date" placeholder="" class="form-control" name="date_birth" value="{{ $profile->date_birth }}" />  </div>
                                                            <div class="form-group form-md-radios">
                                                                ...
                                                                <div class="md-radio-inline">
                                                                    ...
                                                                    <div class="md-radio">
                                                                        <input type="radio" id="radio7" name="gender" class="md-radiobtn" value="Perempuan" checked>
                                                                        <label for="radio7">
                                                                            <span></span>
                                                                            <span class="check"></span>
                                                                            <span class="box"></span> Perempuan </label>
